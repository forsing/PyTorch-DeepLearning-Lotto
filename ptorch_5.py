...
class RNNModel(nn.Module):
    def __init__(self, input_dim=6, hidden_dim=64, output_dim=6):
        super().__init__()
...
def predict_next_combination(model, dataset, device):
    ...
    # Ograniči vrednosti između 1 i 35
    pred_clamped = torch.clamp(pred, 1, 35)
...
def main():
    ...
    train_dataset = LotoDataset("/Users/milan/Desktop/GHQ/data/loto5_109_k100.csv")
...
"""
...
Epoch 995 | Avg loss: 27.1038
Epoch 996 | Avg loss: 26.7468
Epoch 997 | Avg loss: 27.7267
Epoch 998 | Avg loss: 27.4242
Epoch 999 | Avg loss: 25.8666
Epoch 1000 | Avg loss: 26.8396
Time: 3.43s
...
Predikcija (MLP): [5, 11, 16, 22, 27, 4]
Predikcija (RNN): [6, 11, 17, 23, 29, 5]
Predikcija (LSTM): [5, 11, 17, 23, 29, 5]
